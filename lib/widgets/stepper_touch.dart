...
class _Stepper2State extends State<StepperTouch>
  ...
  Widget build(BuildContext context) {
    return FittedBox(
      child: Container(
        width: widget.direction == Axis.horizontal ? 90.0 : 40.0,
        height: widget.direction == Axis.horizontal ? 40.0 : 90.0,
        child: Material(
          ...
          child: Stack(
            ...
            children: <Widget>[
              Positioned(
                left: widget.direction == Axis.horizontal ? 5.0 : null,
                bottom: widget.direction == Axis.horizontal ? null : 5.0,
                child: Icon(Icons.remove, size: 15.0, color: Colors.grey),
              ),
              Positioned(
                right: widget.direction == Axis.horizontal ? 5.0 : null,
                top: widget.direction == Axis.horizontal ? null : 5.0,
                child: Icon(Icons.add, size: 15.0, color: Colors.grey),
              ),
              GestureDetector(
  ...
  void _onPanEnd(DragEndDetails details) {
    ...
    if (_controller.value <= -0.20) {
      ...
      setState(() => isHor ? _value++ : _value < 1 ? 0 : _value--);
      changed = true;
    }
