...
class CreateParcelFragment extends StatefulWidget {
  _CreateParcelFragmentState createState() => _CreateParcelFragmentState();
}

class _CreateParcelFragmentState extends State<CreateParcelFragment> {
