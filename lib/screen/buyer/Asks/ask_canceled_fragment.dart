...
class AskCanceledFragment extends StatefulWidget {
  @override
  _AskCanceledFragmentState createState() => _AskCanceledFragmentState();
}

class _AskCanceledFragmentState extends State<AskCanceledFragment>
  ...
  Future<List<String>> getData() async {
    ...
    db.getAskListByuID(Util.uid, 'canceled').listen((snapshot) {
      asks = snapshot.documents
          .map((docsnap) => Ask.fromMap(docsnap.data))
          .toList();
      setState(() {
