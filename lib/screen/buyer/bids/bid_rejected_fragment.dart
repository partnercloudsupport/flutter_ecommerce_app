...
class BidRejectedFragment extends StatefulWidget {
  @override
  _BidRejectedFragmentState createState() => _BidRejectedFragmentState();
}

class _BidRejectedFragmentState extends State<BidRejectedFragment>
  ...
  Future<List<String>> getData() async {
    ...
    db.getBidListByuID(Util.uid, 'rejected').listen((snapshot) {
