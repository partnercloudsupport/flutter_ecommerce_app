...
class _BidHistoryPageState extends State<BidHistoryPage>
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          "My bid history",
          style: TextStyle(
              fontSize: 30.0, fontFamily: 'Cabin Sketch', color: Colors.white),
        ),
      ),
      body: !loading
          ? RefreshIndicator(
  ...
  Future<List<String>> getData() async {
    ...
    // db.getBidListBysID(Util.uid).listen(( snapshot){
    //     final List<Bid> products = snapshot.documents.map((doc_snap)=>Bid.fromMap(doc_snap.data)).toList();
    //     setState(() {
