...
class BidActiveFragment extends StatefulWidget {
  @override
  _BidActiveFragmentState createState() => _BidActiveFragmentState();
}

class _BidActiveFragmentState extends State<BidActiveFragment>
  ...
  Future<List<String>> getData() async {
    ...
    db.getBidListByuID(Util.uid, 'active').listen((snapshot) {
                ...
                children: <Widget>[
                  ...
                  Row(
                    children: <Widget>[
                      ...
                      Text(
                        widget.item.amount + "X(${widget.item.quantity})",
                        style: TextStyle(
