...
import 'package:flutter_ecommerce/screen/supplier/bid_detail_page.dart';
...
class BidCompletededFragment extends StatefulWidget {
  @override
  _BidCompletededFragmentState createState() => _BidCompletededFragmentState();
}

class _BidCompletededFragmentState extends State<BidCompletededFragment>
  ...
  Future<List<String>> getData() async {
    ...
    db.getBidListByuID(Util.uid, 'completed').listen((snapshot) {
                ...
                children: <Widget>[
                  ...
                  Row(
                    children: <Widget>[
                      ...
                      Text(
                        DateFormat.yMMMd().format(DateTime.parse(
                                widget.item.updated_date.split(" ")[0]
                                .replaceAll(' ', 'T')
                                .replaceAll(':', '')
                                .replaceAll('-', ''))),
                        style: TextStyle(
